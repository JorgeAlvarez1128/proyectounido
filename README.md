...
Proyecto web desarrollado con una API generica en C# y un frontend en Blazor.

## Ultima entrega

Esta ultima entrega consta de darle una identidad visual al proyecto, adecuando la interfaz con colores, imagenes y elementos graficos asociados al Arsenal. Adicionalmente, el proyecto fue preparado para ser publicado como una pagina publica.
...
|---|---|---|
| Administrador | admin@proyectounido.local | admin123 |
| Editor | editor@proyectounido.local | admin123 |
| Consulta | consulta@proyectounido.local | admin123 |
...
```bash
dotnet run --project ./ApiGenericaCsharp/ApiGenericaCsharp.csproj
